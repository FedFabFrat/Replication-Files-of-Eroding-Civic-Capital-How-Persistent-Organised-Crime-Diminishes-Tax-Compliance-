...
qui foreach y of varlist ihs_d100f_tv_ {
	...
	qui imperfectiv residy1 (residx1=residz1), vce(boot, reps(100)) seed(1234) 
	...
	qui imperfectiv residy2 (residx2=residz2), vce(boot, reps(100)) seed(1234)
	...
	qui imperfectiv residy3 (residx3=residz3), vce(boot, reps(100)) seed(1234)
	...
	qui imperfectiv residy4 (residx4=residz4), vce(boot, reps(100)) seed(1234)
...
esttab ihs_d100f_tv__ols_a ihs_d100f_tv__ols_d ihs_d100f_tv__ols_c ihs_d100f_tv__ols_b using "$tables/Table-3.tex", /// 
...
esttab ihs_d100f_tv__ss_a ihs_d100f_tv__ss_d ihs_d100f_tv__ss_c ihs_d100f_tv__ss_b using "$tables/Table-3.tex", /// 
