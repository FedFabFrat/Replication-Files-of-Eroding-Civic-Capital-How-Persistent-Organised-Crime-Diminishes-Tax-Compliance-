...
psmatch2 confino $matching, common neigh(3) 
...
preserve
collapse (max) popolazione_residente_1930 popolazione_residente_1950 densita_demografica_1950 inc_abitazioni_proprieta_1950 incidenza_analfabeti_1950 indice_vecchiaia_1950 tasso_occ_agric_1950 tasso_occ_industr_1950 tasso_occ_terz_1950 tasso_occ_comm_1950 altitude area confino unita_30_1950 unita_31_1950 unita_40_1950 unita_50_1950 unita_60_1950 unita_70_1950 unita_80_1950 unita_90_1950 addetti_30_1950 addetti_31_1950 addetti_40_1950 addetti_50_1950 addetti_60_1950 addetti_70_1950 addetti_80_1950 addetti_90_1950 (firstnm) idreg, by(codcom)
psmatch2 confino $matching, common neigh(7) 
pstest $matching if _support==1 & _weight!=.
tab _treated if _support==1 & _weight!=.
keep if _support==1 & _weight!=.
gen nn7 = 1
...
restore
preserve
gen temp = d100f_tv_ if anno == 1950
collapse (max) popolazione_residente_1930 popolazione_residente_1950 densita_demografica_1950 inc_abitazioni_proprieta_1950 incidenza_analfabeti_1950 indice_vecchiaia_1950 tasso_occ_agric_1950 tasso_occ_industr_1950 tasso_occ_terz_1950 tasso_occ_comm_1950 altitude area confino unita_30_1950 unita_31_1950 unita_40_1950 unita_50_1950 unita_60_1950 unita_70_1950 unita_80_1950 unita_90_1950 addetti_30_1950 addetti_31_1950 addetti_40_1950 addetti_50_1950 addetti_60_1950 addetti_70_1950 addetti_80_1950 addetti_90_1950 temp (firstnm) idreg, by(codcom)
gen ihs_temp = log(temp + (temp^2+1)^0.5)
psmatch2 confino $matching, common radius caliper(0.01)
pstest $matching if _support==1 & _weight!=.
tab _treated if _support==1 & _weight!=.
keep if _support==1 & _weight!=.
gen radius = 1
...
preserve
collapse (max) popolazione_residente_1930 popolazione_residente_1950 densita_demografica_1950 inc_abitazioni_proprieta_1950 incidenza_analfabeti_1950 indice_vecchiaia_1950 tasso_occ_agric_1950 tasso_occ_industr_1950 tasso_occ_terz_1950 tasso_occ_comm_1950 altitude area confino unita_30_1950 unita_31_1950 unita_40_1950 unita_50_1950 unita_60_1950 unita_70_1950 unita_80_1950 unita_90_1950 addetti_30_1950 addetti_31_1950 addetti_40_1950 addetti_50_1950 addetti_60_1950 addetti_70_1950 addetti_80_1950 addetti_90_1950 (firstnm) idreg, by(codcom)
psmatch2 confino $matching, common kernel kerneltype(epan)
pstest $matching if _support==1 & _weight!=.
tab _treated if _support==1 & _weight!=.
keep if _support==1 & _weight!=.
gen kernel = 1
...
save `kernel'
restore
merge m:1 codcom using `nn3'
drop _merge
merge m:1 codcom using `nn7'
drop _merge
merge m:1 codcom using `radius'
drop _merge
merge m:1 codcom using `kernel'
drop _merge
qui summ d100f_tv_ if nn3 == 1
local mean_1: display %10.3f r(mean)
qui summ d100f_tv_ if nn7 == 1
local mean_2: display %10.3f r(mean)
qui summ d100f_tv_ if radius == 1
local mean_3: display %10.3f r(mean)
qui summ d100f_tv_ if kernel == 1
local mean_4: display %10.3f r(mean)
local panel_A_prehead "\begin{table}[!h]\centering\begin{threeparttable}" ///
 "\caption{Forced resettlement and TV tax compliance. Alternative PSM samples. \label{tab:rob-rf-matching-alt}}" ///
...
"In column (1) the sample is restricted to one resulting from a nearest neighbour matching strategy with 3 neighbours, in column (2) with 7 neighbours, in column (3) from a kernel (epanechnikov) strategy, and in column (4) from a radius strategy. " + ///
"The matching strategy is based on the following variables: population (1930, 1950), population density (1950), elderly index (1950), illiterate index (1950), owned house index (1950), and employment rate in agriculture, industry, commerce and tertiary (1950), altitude, area, the number of employees by 2-digit sector (1950) and the number of firms by 2-digit sector (1950). We include municipality and decade fixed effects and province * decade fixed effects, respectively. " + ///
"Municipality clustered standard errors in parentheses. * p$<$0.10, ** p$<$0.05, *** p$<$0.01. "
local panel_A_postfoot "Mean TV tax&`mean_1'&`mean_2'&`mean_3'&`mean_4' \\ \hline  " ///
"Municipality and decade FE &\checkmark&\checkmark&\checkmark&\checkmark\\ " ///
"Province * decade FE &\checkmark&\checkmark&\checkmark&\checkmark\\ " ///
"PSM type &NN3&NN7&Radius&Kernel\\ \hline\hline " ///
"\end{tabular} \begin{tablenotes} \item \scriptsize{`notes'} \end{tablenotes} \end{threeparttable} \end{table}"
eststo clear
qui eststo: reghdfe ihs_d100f_tv_ confino_t if nn3 == 1, a(i.codcom i.anno i.idprov#i.anno) vce(cluster codcom)  	    
qui eststo: reghdfe ihs_d100f_tv_ confino_t if nn7 == 1, a(i.codcom i.anno i.idprov#i.anno) vce(cluster codcom)  	    
qui eststo: reghdfe ihs_d100f_tv_ confino_t if radius == 1, a(i.codcom i.anno i.idprov#i.anno) vce(cluster codcom)  	    
qui eststo: reghdfe ihs_d100f_tv_ confino_t if kernel == 1, a(i.codcom i.anno i.idprov#i.anno) vce(cluster codcom)  	    
esttab using "$tables/Table-A7.tex", ///
