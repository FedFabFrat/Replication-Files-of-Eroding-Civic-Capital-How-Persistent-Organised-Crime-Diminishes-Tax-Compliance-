...
** FS **
eststo clear
qui eststo es_rf_1: reghdfe ihs_n_news_ lead2 cen treated_t lag1 lag2 lag3 if nn5 == 1, a(codcom anno) vce(cluster codcom)
qui eststo es_rf_2: reghdfe ihs_n_news_ lead2 cen treated_t lag1 lag2 if nn5 == 1, a(codcom anno i.codcom#c.anno) vce(cluster codcom)
qui eststo es_rf_3: reghdfe ihs_n_news_ lead2 cen treated_t lag1 lag2 lag3 if nn5 == 1, a(codcom anno i.idreg#i.anno) vce(cluster codcom)
qui eststo es_rf_4: reghdfe ihs_n_news_ lead2 cen treated_t lag1 lag2 lag3 if nn5 == 1, a(codcom anno i.idprov#i.anno) vce(cluster codcom)
coefplot (es_rf_1), bylabel(Base FE) ///
		 ...
		 byopts(cols(2))
graph export "$figures\Figure-A5.pdf", as(pdf) replace
